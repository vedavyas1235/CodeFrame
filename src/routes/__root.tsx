...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Upload an HTML animation, preview it, and export a crisp MP4 — all in your browser." },
      { property: "og:title", content: "CodeFrame — HTML to MP4" },
      { property: "og:description", content: "Convert HTML/CSS animations into high-quality MP4 video, right in the browser." },
